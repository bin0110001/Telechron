...
{
    /// <inheritdoc />
    public partial class InitialSecurityPrerequisites : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthCredentialHash = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepairPolicy = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Secrets_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMemberships_UserId_ProjectId",
                table: "ProjectMemberships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Secrets_Handle",
                table: "Secrets",
                column: "Handle",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Secrets_ProjectId",
                table: "Secrets",
                column: "ProjectId");
